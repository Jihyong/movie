...
$('.login').submit(function(e) {
		...
		self.children().fadeOut(300,function(){ $(this).remove() })
		$('<p class="login__title">sign in <br><span class="login-edition">영화예매시스템에 오신걸 환영합니다.</span></p><p class="success">성공적으로<br> 로그인 되셨습니다.</p><p class="move"><a href="book1.html" class="slide__link">예매하러가기</p>' ).appendTo(self)
		.hide().delay(300).fadeIn();
